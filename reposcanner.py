...
scanned_commits = []
ignored_extensions = (
                     ".dll", ".lnk", ".sys", ".swf", ".jar", ".gzquar", ".scr", ".zix", ".com",
                     ".ocx", ".bat", ".vbs", ".class", ".bin", ".ws", ".drv", ".ozd", ".wmf", ".aru", ".shs", ".chm", ".dev",
                     ".pgm", ".xnxx", ".pif", ".xlm", ".vbe", ".vxd", ".tps", ".vba", ".pcx", ".boo", ".sop", ".hlp", ".tsa", 
                     ".vb", ".scr", ".dxj", ".bkd", ".rhk", ".lik", ".vbx", ".osa", ".cih", ".mjz", ".wsc", ".dlb", ".dyz", ".dom", 
                     ".hlw", ".cla", ".mjg", ".mfu", ".dyv", ".kcd", ".spam", ".bup", ".rsc_tmp", ".mcq", ".wsh", ".upa", ".bhx", 
                     ".txs", ".dli", ".bxz", ".cxq", ".xir", ".xlv", ".xdu", ".fnr", ".ska", ".cfxxe", ".tti", ".smtmp", ".dllx", ".vexe",
                     ".qrn", ".xtbl", ".fag", ".oar", ".ceo", ".uzy", ".tko", ".bll", ".dbd", ".plc", ".smm", ".ssy", ".blf", ".zvz",
                     ".cc", ".nls", ".ctbl", ".hsq", ".iws", ".vzr", ".lkh", ".ezt", ".rna", ".hts", ".let", ".atm", ".fuj", ".buk",
                     ".fjl", ".aut", ".delf", ".bps", ".cyw", ".bmw", ".iva", ".pid", ".dx", ".bqf", ".qit", ".pr", ".lok", ".xnt"
                     )
ignored_files = (
                "composer.lock",
